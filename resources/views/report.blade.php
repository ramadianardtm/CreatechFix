...
<div class="category-container">
    <div class="row">
        ...
        <div class="col-md-1">
            <button type="button" class="btn" style="background: #fff;" data-toggle="modal" data-target="#filtermodal"><i class="fa-solid fa-filter" style="font-size:20px; color:#000;opacity:0.9;"></i></button>
        </div>
    </div>
    <hr size="2" color="#000">
    ...
    <div class="alert-danger" style="margin-bottom:30px;">
        Failed to filter date. {{ $errors->first() }}
    </div>
    @endif

    @if ($transaction->count() == 0)
    <p>Your sales is empty, please sales more !</p>
    @else
